...
6789
	...
	int num2 = MAGICNUMBER + 2;
	cout << "num: " << num << endl;
	cout << "num2: " << num2 << endl;
#endif // ex1

#ifdef ex2
#define MAGICADD(NUM) MAGICNUMBER + NUM
	int num3 = MAGICADD(300);
	cout << "num3: " << num3 << endl;
#define MAGICADD(NUM,NUM2) NUM + NUM2
	int num4 = MAGICADD(300, 200);
	cout << "num4: " << num4 << endl;
...
#define MAGICMULT(NUM,NUM2) NUM*NUM2
	int num6 = MAGICMULT(NUM, NUM2) NUM * NUM2
	cout << "num6: " << num6 << endl;
